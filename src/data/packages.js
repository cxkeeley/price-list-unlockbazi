const packages = [
  ...
  },
  {
    ...
    price: "Rp 3.500.000",
    focus: "Bedah tuntas, interaktif, dan solusi personal",
    featured: true,
    includes: [
      "Laporan tertulis komprehensif (sama dengan Paket Advanced)",
      ...
      "Akses konsultasi bulanan: 1 tanya jawab per bulan (kuota hangus bila tidak digunakan — berlaku bulan berjalan saja)",
    ],
